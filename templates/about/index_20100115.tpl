 ...
 *
 * $Id: index.tpl,v 1.35 2008/06/11 18:55:18 asmecher Exp $
 *}
...
<!--
	local customization: added link to board members
-->
	{if not ($publicFilesDir == "http://journal.lib.uoguelph.ca/public/journals/5")}
		<li>&#187; <a href="{url op="boardMembers"}">Board Members</a></li>
	{/if}

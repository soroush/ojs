...
<!-- 
	local customization: link to splash gallery for CSI journal
-->
{if $publicFilesDir == "http://quasar.lib.uoguelph.ca/public/journals/2"}	
	<p>
	<b><a href="splashGallery">Gallery of splash pages</a></b></p>
{/if}
{if $publicFilesDir == "http://journal.lib.uoguelph.ca/public/journals/2"}	
	<p>
	<b><a href="splashGallery">Gallery of splash pages</a></b></p>
{/if}
{if $publicFilesDir == "http://www.criticalimprov.com/public/journals/2"}	
	<p>
	<b><a href="splashGallery">Gallery of splash pages</a></b></p>
{/if}
</div>

 ...
 *}
<!--
	local customization: added body id
-->
<body id="rtBody">

<!--
	local customization: changed div id
-->
<div id="rtContainer">
<!--
	local customization: changed div id
	local customization: removed font from div
-->
<div id="rtMain" style="width: 150px; font-size: 0.7em; padding-top: 1.5em; padding-left: 1em">
